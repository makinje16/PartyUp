...
const SUMMONER_INFO_BY_NAME_ENDPOINT: &str = "https://na1.api.riotgames.com/lol/summoner/v4/summoners/by-name/";
const RANKED_INFO_BY_SUMMONER_ID_ENDPOINT : &str = "https://na1.api.riotgames.com/lol/league/v4/positions/by-summoner/";
...
impl Client {
    ...
    pub fn get_ranked_info(&self, summoner_name: &String) -> Vec<RankedQueue> {
        let endpoint = build_endpoint(self, SUMMONER_INFO_BY_NAME_ENDPOINT,
                                        &summoner_name);
